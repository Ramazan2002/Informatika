    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(default=datetime.datetime(2021, 11, 7, 13, 37, 50, 982718, tzinfo=utc), editable=False)),
                ('join_date', models.DateTimeField(default=datetime.datetime(2021, 11, 7, 13, 37, 50, 982757, tzinfo=utc), editable=False)),
            ],
        ),
        migrations.CreateModel(
            name='Group',
