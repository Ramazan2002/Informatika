    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(default=datetime.datetime(2021, 10, 30, 15, 33, 58, 815519, tzinfo=utc), editable=False)),
                ('join_date', models.DateTimeField(default=datetime.datetime(2021, 10, 30, 15, 33, 58, 815556, tzinfo=utc), editable=False)),
            ],
        ),
        migrations.CreateModel(
            name='Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(default='default_avatar/1.jpeg', upload_to='user_avatars/')),
            ],
        ),
        migrations.AddField(
